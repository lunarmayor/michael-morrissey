    ...
    <Flex px={[1, 2, 4]} py={[0, 2]} wrap>
      ...
      <Box p={2} w={[1, 2 / 3]}>
        <H1 style={{ marginTop: 0 }}>
          Let's gaze into the abyss of my identity together
        </H1>
        <H2>
          I'm a <span>full stack developer</span> and <span>ux designer</span>
        </H2>
        <H2 style={{ marginBottom: "2em" }}>
          I'm happiest when I'm rapidly prototyping for the benefit of human
          beings
        </H2>
        <H2>Skills</H2>
        <Flex wrap>
